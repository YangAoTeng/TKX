...
void MX_FREERTOS_Init(void) {
  ...
  /* add threads, ... */
  ESP01_Init(); // Initialize the ESP01 module
...
void StartDefaultTask(void *argument)
{
  ...
  // ESP01_test(); // Test the ESP01 module
  osDelay(1000);
  ESP01_test();
  ESP01_ConnectWiFi("1601", "yangaoteng1997"); // Connect to WiFi
  ESP01_CreateTCPServer(8080); // Create a TCP server on port 8080
  /* Infinite loop */
  for(;;)
  {
